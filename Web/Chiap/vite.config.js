  ...
  build: {
    rollupOptions: {
      input: {
        ...
        friendNoti: path.resolve(__dirname, 'friendNoti.html'),
        resetPassword: path.resolve(__dirname, 'resetPassword.html'),
        forgotPassword: path.resolve(__dirname, 'forgotPassword.html'),
        userSettings: path.resolve(__dirname, 'userSettings.html'),
      }
    }
  }
});
